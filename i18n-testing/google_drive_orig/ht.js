...
export default {
  ...
  footer: {
    'header_v1.0':    `Cliff Effects Tool`,
    'cfbCredit_v0': [
      `Made with `,
      { name: `__heartIcon__` },
      ` by Code for Boston`, 
...
'why2_v1.0': `Efe de klif yo difisil pou prevwa, Enteraksyon ant revni, kantite moun ki nan kay la, anpil lot krite,anplis efe pwogram yo yo menm ki afekte yonn lot nan fason ke nou pa atann. Nou ap chache fason pou nou fe fas ak komplex pwoblem  sa a e ede fanmiy yo konprann e prevwa sitiyasyon yo.`,

    'videoLinkText_v1.0':    `2 minit videyo ki pale de cliff effects`,
    'quantLinkText_v1.0':    `Kantitativ prezantasyon ki demontre cliff effects`,
    'benefitsLinkText_v0': `Detay de diferant benefis ki ofri nan MA’, ’

`
'howToUseHeader_v1.0:` Koman mwen ka itilize enstriman sa a?`,

    'howtoUse_v1.0':       `Ale etap pa etap pou adisyone enfomasyon konsenan  aktyel benefis kliyan an,kay la, revni, e lot enfomasyon.Enfomasyon sa a ap sevi pou prevwa apepre montan ke kliyan an ap resevwa. Le ou fini, chanje “ fiti revni” an pou we koman chanjman nan revni an ka koz yon chanjman nan kantiti benefis lan. Aktyelman, SNAP e Seksyon 8 sibvansyon pwogram kay yo disponib. Note ke previzyon yo ka pa direkteman korespond avek aktyel montan benefis lan. Fokis aplikasyon an se kantite chanjman ki fet nan benefis le gen chanjman nan revni ke moun yo genyen.`,
    'howToUseNote_v1.0': [
